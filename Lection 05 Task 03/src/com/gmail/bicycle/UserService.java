...
public class UserService {
	...
	public static void demoDAOPlainText(Group group) {
	...
	public static void demoDAOJSONText(Group group) {
		DAOFactory groupDAOFactory = DAOFactory.getDAOFactory(DAOFactory.JSON);
		GroupDAO groupDAO = groupDAOFactory.getGroupDAO();
	...
	public static void demoJSON(Group group) {
